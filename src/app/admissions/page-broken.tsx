  ...
  const applicationSteps = [
    {
      ...
      description:
        "Discover your perfect course from our wide range of programs",
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {keyDates.map((date, index) => (
                  <div key={index} className="text-center group">
                    ...
                    ></div>
                    <div className="font-bold text-white text-lg md:text-xl mb-2">{date.event}</div>
                    <div className="text-neutral-200 text-base md:text-lg font-semibold">{date.date}</div>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl md:text-2xl text-neutral-600 max-w-4xl mx-auto leading-relaxed">
              Follow these four straightforward steps to begin your journey at
              FS University.
            </p>
          </div>
          ...
          <div className="relative grid md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            {applicationSteps.map((step, index) => (
              <Card
                key={index}
                className="text-center p-8 bg-red-50/50 hover:bg-red-50 hover:shadow-xl transition-all duration-300 relative border-2 border-transparent hover:border-[var(--fsu-gold)]/30"
              >
                <div className="w-20 h-20 bg-[var(--fsu-crimson)] rounded-full flex items-center justify-center text-white text-2xl font-bold mx-auto mb-6 shadow-lg">
                  {step.step}
                </div>
                <div className="w-16 h-16 bg-[var(--fsu-gold)] rounded-full flex items-center justify-center text-[var(--fsu-crimson)] mx-auto mb-6 shadow-lg">
                  {step.icon}
                </div>
                ...
                {index < applicationSteps.length - 1 && (
                  <div className="hidden lg:block absolute top-20 -right-6 z-10">
                    <div className="w-12 h-0.5 bg-[var(--fsu-gold)]"></div>
                    <div className="absolute -right-1 -top-1 w-3 h-3 border-r-2 border-t-2 border-[var(--fsu-gold)] transform rotate-45"></div>
                  </div>
                )}
              </Card>
            ))}
